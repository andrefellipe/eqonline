		...
		<div class="row">
			<div class="col-md-5 mx-auto">
				<div class="myform">
					...
					<form action="/admin/login" method="post">
						...
						<div class="form-group">
							...
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="customCheck" name="inremember" value="1">
								<label class="custom-control-label" for="customCheck">Salvar a senha</label>
							</div>
					...
					<p class="text-center">Esqueceu a senha? <a href="/admin/forgot">Clique aqui.</a></p>
