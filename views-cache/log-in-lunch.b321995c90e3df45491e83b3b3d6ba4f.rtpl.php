  ...
  <section class="content-header">
    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <h1>Registrar Fim de Intervalo</h1>
        </div>
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Registrar Fim de Intervalo</li>
          </ol>
        </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <form role="form" action="/admin/log/in/lunch/<?php echo htmlspecialchars( $user["id_user"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
              <div class="card-body">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary">Registrar Fim de Intervalo</button>
              </div>
