          ...
          <div class="card-body table-responsive">
            <table id="search-table" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo htmlspecialchars( $value1["id_client"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                  ...
                  <td>
                    <a href="/admin/clients/<?php echo htmlspecialchars( $value1["id_client"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                    <a href="/admin/clients/<?php echo htmlspecialchars( $value1["id_client"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este cliente?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
                </tr>
                <?php } ?>
