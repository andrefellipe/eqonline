            ...
            <form role="form">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="radio">
                    <label><input type="radio" name="log-type"> A Receber</label>
                  </div>
                  <div class="radio">
                    <label><input type="radio" name="log-type"> Recebida</label>
                  </div>
                  <div class="radio">
                    <label><input type="radio" name="log-type"> A Pagar</label>
                  </div>
                  <div class="radio">
