			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-header">
						<a href="/admin/bills/to-pay/create" class="btn btn-success">Cadastrar Conta a Pagar</a>
						<a href="/admin/bills/to-pay/report" class="btn btn-info">Gerar Relatório</a>
					</div>
						...
						<table id="search-table" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="/admin/bills/to-pay/<?php echo htmlspecialchars( $value1["id_bill"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
										<a href="/admin/bills/to-pay/<?php echo htmlspecialchars( $value1["id_bill"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir esta conta a pagar?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Excluir</a>
									</td>
								</tr>
								<?php } ?>
