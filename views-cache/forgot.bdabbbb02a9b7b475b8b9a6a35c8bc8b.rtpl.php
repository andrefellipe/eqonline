...
<head>
  ...
  <title>E&Q Online: Recuperar Senha</title>
      ...
      <div class="col-md-5 mx-auto">
        <div class="myform">
          ...
          <form action="/admin/forgot" method="post">
            ...
            <div class="col-md-12 text-center">
              <p>Digite seu email para ter instruções de recuperação.</p>
            </div>
            ...
            <div class="col-md-12 text-center">
              <button type="submit" class=" btn btn-block mybtn btn-primary tx-tfm">Recuperar</button>
            </div>
