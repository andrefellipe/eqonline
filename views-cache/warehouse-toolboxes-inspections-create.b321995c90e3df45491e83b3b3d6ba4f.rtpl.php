      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="/admin/warehouse/toolboxes/<?php echo htmlspecialchars( $toolbox["id_toolbox"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/inspections">Vistorias</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <form role="form" action="/admin/warehouse/toolboxes/<?php echo htmlspecialchars( $toolbox["id_toolbox"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/inspections/create" method="post">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_toolbox" value="<?php echo htmlspecialchars( $toolbox["id_toolbox"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly>
                </div>

                <div class="form-group">
                  <label>Maleta</label>
                  <input type="text" class="form-control" name="des_description" value="<?php echo htmlspecialchars( $toolbox["des_description"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly>
                </div>
