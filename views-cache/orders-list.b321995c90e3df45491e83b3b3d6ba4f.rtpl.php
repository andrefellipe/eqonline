      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <form role="form" action="/admin/orders/<?php echo htmlspecialchars( $order["id_order"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/list" method="post">
              <div class="card-body">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary">Gerar Lista</button>
              </div>
