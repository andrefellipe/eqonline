      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <a href="/admin/transport/vehicles/<?php echo htmlspecialchars( $vehicle["id_vehicle"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/inspections/create" class="btn btn-success">Cadastrar Vistoria</a>
          </div>
          ...
          <div class="card-body table-responsive">
            <table id="search-table" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo htmlspecialchars( $value1["id_v_inspection"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
