            ...
            <div class="row" style="margin-top: 25px">
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info-gradient">
                  ...
                  <a href="/admin/log/in/317" class="small-box-footer">
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success-gradient">
                  ...
                  <a href="/admin/log/out/317" class="small-box-footer">
                    Clique aqui <i class="fa fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-dark-gradient">
                  ...
                  <a href="/admin/log/in/extra/317" class="small-box-footer">
                    Clique aqui <i class="fa fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-secondary-gradient">
                  ...
                  <a href="/admin/log/out/extra/317" class="small-box-footer">
                    Clique aqui <i class="fa fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
